...
namespace Quiz.Base.Collections
{
    public class AnswerCollection : IEnumerable<Answer>
    {
        readonly List<Answer> _options = new List<Answer>();
        ...
        {
            return ((IEnumerable<Answer>) _options).GetEnumerator();
        }
        ...
        /// </summary>
        /// <param name="i">The zero-based of the element to get or set.</param>
